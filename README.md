...
This is an internal training material for introductory level in Python. The audience is expected to have a basic to intermediate level of R programming, but no Python background is required. There are 4 main topics discussed in this training:
